...
object (self)
  ...
  method get_count = Some _count
  method grab_count = _count
  method set_count _x125 = _count <- _x125
  method reset_count = _count <- 100
...
let rec read_keyRange (iprot : Protocol.t) =
  let _str128 = new keyRange in
    ignore(iprot#readStructBegin);
    (try while true do
        let (_,_t129,_id130) = iprot#readFieldBegin in
        if _t129 = Protocol.T_STOP then
          raise Break
        else ();
        (match _id130 with 
          | 1 -> (if _t129 = Protocol.T_STRING then
              _str128#set_start_key iprot#readString
            else
              iprot#skip _t129)
          | 2 -> (if _t129 = Protocol.T_STRING then
              _str128#set_end_key iprot#readString
            else
              iprot#skip _t129)
          | 3 -> (if _t129 = Protocol.T_STRING then
              _str128#set_start_token iprot#readString
            else
              iprot#skip _t129)
          | 4 -> (if _t129 = Protocol.T_STRING then
              _str128#set_end_token iprot#readString
            else
              iprot#skip _t129)
          | 5 -> (if _t129 = Protocol.T_I32 then
              _str128#set_count iprot#readI32
            else
              iprot#skip _t129)
          | _ -> iprot#skip _t129);
        iprot#readFieldEnd;
...
object (self)
  ...
  method get_key = _key
  method grab_key = match _key with None->raise (Field_empty "keySlice.key") | Some _x132 -> _x132
  method set_key _x132 = _key <- Some _x132
  method unset_key = _key <- None
  method reset_key = _key <- None

  val mutable _columns : columnOrSuperColumn list option = None
  method get_columns = _columns
  method grab_columns = match _columns with None->raise (Field_empty "keySlice.columns") | Some _x133 -> _x133
  method set_columns _x133 = _columns <- Some _x133
  method unset_columns = _columns <- None
  method reset_columns = _columns <- None
  ...
  method write (oprot : Protocol.t) =
    ...
    | Some _v -> 
      oprot#writeFieldBegin("columns",Protocol.T_LIST,2);
      oprot#writeListBegin(Protocol.T_STRUCT,List.length _v);
      List.iter (fun _iter136 ->         _iter136#write(oprot);
      ) _v;
      oprot#writeListEnd;
      oprot#writeFieldEnd
    );
...
let rec read_keySlice (iprot : Protocol.t) =
  let _str137 = new keySlice in
    ignore(iprot#readStructBegin);
    (try while true do
        let (_,_t138,_id139) = iprot#readFieldBegin in
        if _t138 = Protocol.T_STOP then
          raise Break
        else ();
        (match _id139 with 
          | 1 -> (if _t138 = Protocol.T_STRING then
              _str137#set_key iprot#readString
            else
              iprot#skip _t138)
          | 2 -> (if _t138 = Protocol.T_LIST then
              _str137#set_columns 
                (let (_etype143,_size140) = iprot#readListBegin in
                  let _con144 = (Array.to_list (Array.init _size140 (fun _ -> (read_columnOrSuperColumn iprot)))) in
                    iprot#readListEnd; _con144)
            else
              iprot#skip _t138)
          | _ -> iprot#skip _t138);
        iprot#readFieldEnd;
...
object (self)
  val mutable _key : string option = None
  method get_key = _key
  method grab_key = match _key with None->raise (Field_empty "keyCount.key") | Some _x146 -> _x146
  method set_key _x146 = _key <- Some _x146
  method unset_key = _key <- None
  method reset_key = _key <- None

  val mutable _count : int option = None
  method get_count = _count
  method grab_count = match _count with None->raise (Field_empty "keyCount.count") | Some _x147 -> _x147
  method set_count _x147 = _count <- Some _x147
...
let rec read_keyCount (iprot : Protocol.t) =
  let _str150 = new keyCount in
    ...
    (try while true do
        ...
        (match _id152 with 
          | 1 -> (if _t151 = Protocol.T_STRING then
              _str150#set_key iprot#readString
            else
              iprot#skip _t151)
          | 2 -> (if _t151 = Protocol.T_I32 then
              _str150#set_count iprot#readI32
            else
              iprot#skip _t151)
          | _ -> iprot#skip _t151);
        iprot#readFieldEnd;
...
object (self)
  val mutable _timestamp : Int64.t option = None
  method get_timestamp = _timestamp
  method grab_timestamp = match _timestamp with None->raise (Field_empty "deletion.timestamp") | Some _x154 -> _x154
  method set_timestamp _x154 = _timestamp <- Some _x154
  method unset_timestamp = _timestamp <- None
  method reset_timestamp = _timestamp <- None

  val mutable _super_column : string option = None
  method get_super_column = _super_column
  method grab_super_column = match _super_column with None->raise (Field_empty "deletion.super_column") | Some _x155 -> _x155
  method set_super_column _x155 = _super_column <- Some _x155
  method unset_super_column = _super_column <- None
  method reset_super_column = _super_column <- None

  val mutable _predicate : slicePredicate option = None
  method get_predicate = _predicate
  method grab_predicate = match _predicate with None->raise (Field_empty "deletion.predicate") | Some _x156 -> _x156
  method set_predicate _x156 = _predicate <- Some _x156
...
let rec read_deletion (iprot : Protocol.t) =
  let _str159 = new deletion in
    ...
    (try while true do
        ...
        (match _id161 with 
          | 1 -> (if _t160 = Protocol.T_I64 then
              _str159#set_timestamp iprot#readI64
            else
              iprot#skip _t160)
          | 2 -> (if _t160 = Protocol.T_STRING then
              _str159#set_super_column iprot#readString
            else
              iprot#skip _t160)
          | 3 -> (if _t160 = Protocol.T_STRUCT then
              _str159#set_predicate (read_slicePredicate iprot)
            else
              iprot#skip _t160)
          | _ -> iprot#skip _t160);
        iprot#readFieldEnd;
...
object (self)
  ...
  method grab_column_or_supercolumn = match _column_or_supercolumn with None->raise (Field_empty "mutation.column_or_supercolumn") | Some _x163 -> _x163
  method set_column_or_supercolumn _x163 = _column_or_supercolumn <- Some _x163
  ...
  method grab_deletion = match _deletion with None->raise (Field_empty "mutation.deletion") | Some _x164 -> _x164
  method set_deletion _x164 = _deletion <- Some _x164
...
let rec read_mutation (iprot : Protocol.t) =
  let _str167 = new mutation in
    ...
    (try while true do
        ...
        (match _id169 with 
          | 1 -> (if _t168 = Protocol.T_STRUCT then
              _str167#set_column_or_supercolumn (read_columnOrSuperColumn iprot)
            else
              iprot#skip _t168)
          | 2 -> (if _t168 = Protocol.T_STRUCT then
              _str167#set_deletion (read_deletion iprot)
            else
              iprot#skip _t168)
          | _ -> iprot#skip _t168);
        iprot#readFieldEnd;
...
object (self)
  val mutable _start_token : string option = None
  method get_start_token = _start_token
  method grab_start_token = match _start_token with None->raise (Field_empty "tokenRange.start_token") | Some _x171 -> _x171
  method set_start_token _x171 = _start_token <- Some _x171
  method unset_start_token = _start_token <- None
  method reset_start_token = _start_token <- None

  val mutable _end_token : string option = None
  method get_end_token = _end_token
  method grab_end_token = match _end_token with None->raise (Field_empty "tokenRange.end_token") | Some _x172 -> _x172
  method set_end_token _x172 = _end_token <- Some _x172
  method unset_end_token = _end_token <- None
  method reset_end_token = _end_token <- None

  val mutable _endpoints : string list option = None
  method get_endpoints = _endpoints
  method grab_endpoints = match _endpoints with None->raise (Field_empty "tokenRange.endpoints") | Some _x173 -> _x173
  method set_endpoints _x173 = _endpoints <- Some _x173
  ...
  method write (oprot : Protocol.t) =
    ...
    | Some _v -> 
      ...
      oprot#writeListBegin(Protocol.T_STRING,List.length _v);
      List.iter (fun _iter176 ->         oprot#writeString(_iter176);
      ) _v;
      oprot#writeListEnd;
      oprot#writeFieldEnd
    );
...
let rec read_tokenRange (iprot : Protocol.t) =
  let _str177 = new tokenRange in
    ...
    (try while true do
        ...
        (match _id179 with 
          | 1 -> (if _t178 = Protocol.T_STRING then
              _str177#set_start_token iprot#readString
            else
              iprot#skip _t178)
          | 2 -> (if _t178 = Protocol.T_STRING then
              _str177#set_end_token iprot#readString
            else
              iprot#skip _t178)
          | 3 -> (if _t178 = Protocol.T_LIST then
              _str177#set_endpoints 
                (let (_etype183,_size180) = iprot#readListBegin in
                  let _con184 = (Array.to_list (Array.init _size180 (fun _ -> iprot#readString))) in
                    iprot#readListEnd; _con184)
            else
              iprot#skip _t178)
          | _ -> iprot#skip _t178);
        iprot#readFieldEnd;
...
object (self)
  ...
  method grab_credentials = match _credentials with None->raise (Field_empty "authenticationRequest.credentials") | Some _x186 -> _x186
  method set_credentials _x186 = _credentials <- Some _x186
  ...
  method write (oprot : Protocol.t) =
    ...
    | Some _v -> 
      ...
      Hashtbl.iter (fun _kiter189 -> fun _viter190 -> 
        oprot#writeString(_kiter189);
        oprot#writeString(_viter190);
      ) _v;
      oprot#writeMapEnd;
      oprot#writeFieldEnd
    );
...
let rec read_authenticationRequest (iprot : Protocol.t) =
  let _str191 = new authenticationRequest in
    ignore(iprot#readStructBegin);
    (try while true do
        ...
        (match _id193 with 
          | 1 -> (if _t192 = Protocol.T_MAP then
              _str191#set_credentials 
                (let (_ktype195,_vtype196,_size194) = iprot#readMapBegin in
                let _con198 = Hashtbl.create _size194 in
                  for i = 1 to _size194 do
                    let _k = iprot#readString in
                    let _v = iprot#readString in
                      Hashtbl.add _con198 _k _v
                  done; iprot#readMapEnd; _con198)
            else
              iprot#skip _t192)
          | _ -> iprot#skip _t192);
        iprot#readFieldEnd;
...
object (self)
  val mutable _name : string option = None
  method get_name = _name
  method grab_name = match _name with None->raise (Field_empty "columnDef.name") | Some _x200 -> _x200
  method set_name _x200 = _name <- Some _x200
  method unset_name = _name <- None
  method reset_name = _name <- None

  val mutable _validation_class : string option = None
  method get_validation_class = _validation_class
  method grab_validation_class = match _validation_class with None->raise (Field_empty "columnDef.validation_class") | Some _x201 -> _x201
  method set_validation_class _x201 = _validation_class <- Some _x201
  ...
  method grab_index_type = match _index_type with None->raise (Field_empty "columnDef.index_type") | Some _x202 -> _x202
  method set_index_type _x202 = _index_type <- Some _x202
  ...
  method grab_index_name = match _index_name with None->raise (Field_empty "columnDef.index_name") | Some _x203 -> _x203
  method set_index_name _x203 = _index_name <- Some _x203
    ...
    (try while true do
        ...
        (match _id208 with 
          | 1 -> (if _t207 = Protocol.T_STRING then
              _str206#set_name iprot#readString
            else
              iprot#skip _t207)
          | 2 -> (if _t207 = Protocol.T_STRING then
              _str206#set_validation_class iprot#readString
            else
              iprot#skip _t207)
          | 3 -> (if _t207 = Protocol.T_I32 then
              _str206#set_index_type (IndexType.of_i iprot#readI32)
            else
              iprot#skip _t207)
          | 4 -> (if _t207 = Protocol.T_STRING then
              _str206#set_index_name iprot#readString
            else
              iprot#skip _t207)
          | _ -> iprot#skip _t207);
        iprot#readFieldEnd;
...
object (self)
  ...
  method grab_keyspace = match _keyspace with None->raise (Field_empty "cfDef.keyspace") | Some _x210 -> _x210
  method set_keyspace _x210 = _keyspace <- Some _x210
  method unset_keyspace = _keyspace <- None
  method reset_keyspace = _keyspace <- None

  val mutable _name : string option = None
  method get_name = _name
  method grab_name = match _name with None->raise (Field_empty "cfDef.name") | Some _x211 -> _x211
  method set_name _x211 = _name <- Some _x211
  method unset_name = _name <- None
  method reset_name = _name <- None
  ...
  method set_column_type _x212 = _column_type <- _x212
  ...
  method set_comparator_type _x213 = _comparator_type <- _x213
  ...
  method grab_subcomparator_type = match _subcomparator_type with None->raise (Field_empty "cfDef.subcomparator_type") | Some _x214 -> _x214
  method set_subcomparator_type _x214 = _subcomparator_type <- Some _x214
  ...
  method grab_comment = match _comment with None->raise (Field_empty "cfDef.comment") | Some _x215 -> _x215
  method set_comment _x215 = _comment <- Some _x215
  method unset_comment = _comment <- None
  method reset_comment = _comment <- None

  val mutable _row_cache_size : float = 0.0
  method get_row_cache_size = Some _row_cache_size
  method grab_row_cache_size = _row_cache_size
  method set_row_cache_size _x216 = _row_cache_size <- _x216
  method reset_row_cache_size = _row_cache_size <- 0.0

  val mutable _key_cache_size : float = 200000.0
  method get_key_cache_size = Some _key_cache_size
  method grab_key_cache_size = _key_cache_size
  method set_key_cache_size _x217 = _key_cache_size <- _x217
  method reset_key_cache_size = _key_cache_size <- 200000.0

  val mutable _read_repair_chance : float = 1.00000
  method get_read_repair_chance = Some _read_repair_chance
  method grab_read_repair_chance = _read_repair_chance
  method set_read_repair_chance _x218 = _read_repair_chance <- _x218
  method reset_read_repair_chance = _read_repair_chance <- 1.00000

  val mutable _column_metadata : columnDef list option = None
  method get_column_metadata = _column_metadata
  method grab_column_metadata = match _column_metadata with None->raise (Field_empty "cfDef.column_metadata") | Some _x219 -> _x219
  method set_column_metadata _x219 = _column_metadata <- Some _x219
  ...
  method grab_gc_grace_seconds = match _gc_grace_seconds with None->raise (Field_empty "cfDef.gc_grace_seconds") | Some _x220 -> _x220
  method set_gc_grace_seconds _x220 = _gc_grace_seconds <- Some _x220
  ...
  method grab_default_validation_class = match _default_validation_class with None->raise (Field_empty "cfDef.default_validation_class") | Some _x221 -> _x221
  method set_default_validation_class _x221 = _default_validation_class <- Some _x221
  ...
  method get_id = _id
  method grab_id = match _id with None->raise (Field_empty "cfDef.id") | Some _x222 -> _x222
  method set_id _x222 = _id <- Some _x222
  ...
  method grab_min_compaction_threshold = match _min_compaction_threshold with None->raise (Field_empty "cfDef.min_compaction_threshold") | Some _x223 -> _x223
  method set_min_compaction_threshold _x223 = _min_compaction_threshold <- Some _x223
  ...
  method grab_max_compaction_threshold = match _max_compaction_threshold with None->raise (Field_empty "cfDef.max_compaction_threshold") | Some _x224 -> _x224
  method set_max_compaction_threshold _x224 = _max_compaction_threshold <- Some _x224
  ...
  val mutable _row_cache_save_period_in_seconds : int option = None
  method get_row_cache_save_period_in_seconds = _row_cache_save_period_in_seconds
  method grab_row_cache_save_period_in_seconds = match _row_cache_save_period_in_seconds with None->raise (Field_empty "cfDef.row_cache_save_period_in_seconds") | Some _x225 -> _x225
  method set_row_cache_save_period_in_seconds _x225 = _row_cache_save_period_in_seconds <- Some _x225
  ...
  val mutable _key_cache_save_period_in_seconds : int option = None
  method get_key_cache_save_period_in_seconds = _key_cache_save_period_in_seconds
  method grab_key_cache_save_period_in_seconds = match _key_cache_save_period_in_seconds with None->raise (Field_empty "cfDef.key_cache_save_period_in_seconds") | Some _x226 -> _x226
  method set_key_cache_save_period_in_seconds _x226 = _key_cache_save_period_in_seconds <- Some _x226
  ...
  val mutable _memtable_flush_after_mins : int option = None
  method get_memtable_flush_after_mins = _memtable_flush_after_mins
  method grab_memtable_flush_after_mins = match _memtable_flush_after_mins with None->raise (Field_empty "cfDef.memtable_flush_after_mins") | Some _x227 -> _x227
  method set_memtable_flush_after_mins _x227 = _memtable_flush_after_mins <- Some _x227
  ...
  val mutable _memtable_throughput_in_mb : int option = None
  method get_memtable_throughput_in_mb = _memtable_throughput_in_mb
  method grab_memtable_throughput_in_mb = match _memtable_throughput_in_mb with None->raise (Field_empty "cfDef.memtable_throughput_in_mb") | Some _x228 -> _x228
  method set_memtable_throughput_in_mb _x228 = _memtable_throughput_in_mb <- Some _x228
  ...
  method grab_memtable_operations_in_millions = match _memtable_operations_in_millions with None->raise (Field_empty "cfDef.memtable_operations_in_millions") | Some _x229 -> _x229
  method set_memtable_operations_in_millions _x229 = _memtable_operations_in_millions <- Some _x229
  ...
  method grab_replicate_on_write = match _replicate_on_write with None->raise (Field_empty "cfDef.replicate_on_write") | Some _x230 -> _x230
  method set_replicate_on_write _x230 = _replicate_on_write <- Some _x230
  ...
  method grab_merge_shards_chance = match _merge_shards_chance with None->raise (Field_empty "cfDef.merge_shards_chance") | Some _x231 -> _x231
  method set_merge_shards_chance _x231 = _merge_shards_chance <- Some _x231
  ...
  method grab_key_validation_class = match _key_validation_class with None->raise (Field_empty "cfDef.key_validation_class") | Some _x232 -> _x232
  method set_key_validation_class _x232 = _key_validation_class <- Some _x232
  method unset_key_validation_class = _key_validation_class <- None
  method reset_key_validation_class = _key_validation_class <- None

  val mutable _row_cache_provider : string = "org.apache.cassandra.cache.ConcurrentLinkedHashCacheProvider"
  method get_row_cache_provider = Some _row_cache_provider
  method grab_row_cache_provider = _row_cache_provider
  method set_row_cache_provider _x233 = _row_cache_provider <- _x233
  method reset_row_cache_provider = _row_cache_provider <- "org.apache.cassandra.cache.ConcurrentLinkedHashCacheProvider"

  val mutable _key_alias : string option = None
  method get_key_alias = _key_alias
  method grab_key_alias = match _key_alias with None->raise (Field_empty "cfDef.key_alias") | Some _x234 -> _x234
  method set_key_alias _x234 = _key_alias <- Some _x234
  ...
  method write (oprot : Protocol.t) =
    ...
    (match _row_cache_provider with "org.apache.cassandra.cache.ConcurrentLinkedHashCacheProvider" -> () | _v -> 
...
let rec read_cfDef (iprot : Protocol.t) =
  let _str238 = new cfDef in
    ignore(iprot#readStructBegin);
    (try while true do
        let (_,_t239,_id240) = iprot#readFieldBegin in
        if _t239 = Protocol.T_STOP then
          raise Break
        else ();
        (match _id240 with 
          | 1 -> (if _t239 = Protocol.T_STRING then
              _str238#set_keyspace iprot#readString
            else
              iprot#skip _t239)
          | 2 -> (if _t239 = Protocol.T_STRING then
              _str238#set_name iprot#readString
            else
              iprot#skip _t239)
          | 3 -> (if _t239 = Protocol.T_STRING then
              _str238#set_column_type iprot#readString
            else
              iprot#skip _t239)
          | 5 -> (if _t239 = Protocol.T_STRING then
              _str238#set_comparator_type iprot#readString
            else
              iprot#skip _t239)
          | 6 -> (if _t239 = Protocol.T_STRING then
              _str238#set_subcomparator_type iprot#readString
            else
              iprot#skip _t239)
          | 8 -> (if _t239 = Protocol.T_STRING then
              _str238#set_comment iprot#readString
            else
              iprot#skip _t239)
          | 9 -> (if _t239 = Protocol.T_DOUBLE then
              _str238#set_row_cache_size iprot#readDouble
            else
              iprot#skip _t239)
          | 11 -> (if _t239 = Protocol.T_DOUBLE then
              _str238#set_key_cache_size iprot#readDouble
            else
              iprot#skip _t239)
          | 12 -> (if _t239 = Protocol.T_DOUBLE then
              _str238#set_read_repair_chance iprot#readDouble
            else
              iprot#skip _t239)
          | 13 -> (if _t239 = Protocol.T_LIST then
              _str238#set_column_metadata 
                (let (_etype244,_size241) = iprot#readListBegin in
                  let _con245 = (Array.to_list (Array.init _size241 (fun _ -> (read_columnDef iprot)))) in
                    iprot#readListEnd; _con245)
            else
              iprot#skip _t239)
          | 14 -> (if _t239 = Protocol.T_I32 then
              _str238#set_gc_grace_seconds iprot#readI32
            else
              iprot#skip _t239)
          | 15 -> (if _t239 = Protocol.T_STRING then
              _str238#set_default_validation_class iprot#readString
            else
              iprot#skip _t239)
          | 16 -> (if _t239 = Protocol.T_I32 then
              _str238#set_id iprot#readI32
            else
              iprot#skip _t239)
          | 17 -> (if _t239 = Protocol.T_I32 then
              _str238#set_min_compaction_threshold iprot#readI32
            else
              iprot#skip _t239)
          | 18 -> (if _t239 = Protocol.T_I32 then
              _str238#set_max_compaction_threshold iprot#readI32
            else
              iprot#skip _t239)
          | 19 -> (if _t239 = Protocol.T_I32 then
              _str238#set_row_cache_save_period_in_seconds iprot#readI32
            else
              iprot#skip _t239)
          | 20 -> (if _t239 = Protocol.T_I32 then
              _str238#set_key_cache_save_period_in_seconds iprot#readI32
            else
              iprot#skip _t239)
          | 21 -> (if _t239 = Protocol.T_I32 then
              _str238#set_memtable_flush_after_mins iprot#readI32
            else
              iprot#skip _t239)
          | 22 -> (if _t239 = Protocol.T_I32 then
              _str238#set_memtable_throughput_in_mb iprot#readI32
            else
              iprot#skip _t239)
          | 23 -> (if _t239 = Protocol.T_DOUBLE then
              _str238#set_memtable_operations_in_millions iprot#readDouble
            else
              iprot#skip _t239)
          | 24 -> (if _t239 = Protocol.T_BOOL then
              _str238#set_replicate_on_write iprot#readBool
            else
              iprot#skip _t239)
          | 25 -> (if _t239 = Protocol.T_DOUBLE then
              _str238#set_merge_shards_chance iprot#readDouble
            else
              iprot#skip _t239)
          | 26 -> (if _t239 = Protocol.T_STRING then
              _str238#set_key_validation_class iprot#readString
            else
              iprot#skip _t239)
          | 27 -> (if _t239 = Protocol.T_STRING then
              _str238#set_row_cache_provider iprot#readString
            else
              iprot#skip _t239)
          | 28 -> (if _t239 = Protocol.T_STRING then
              _str238#set_key_alias iprot#readString
            else
              iprot#skip _t239)
          | _ -> iprot#skip _t239);
        iprot#readFieldEnd;
...
object (self)
  val mutable _name : string option = None
  method get_name = _name
  method grab_name = match _name with None->raise (Field_empty "ksDef.name") | Some _x247 -> _x247
  method set_name _x247 = _name <- Some _x247
  method unset_name = _name <- None
  method reset_name = _name <- None

  val mutable _strategy_class : string option = None
  method get_strategy_class = _strategy_class
  method grab_strategy_class = match _strategy_class with None->raise (Field_empty "ksDef.strategy_class") | Some _x248 -> _x248
  method set_strategy_class _x248 = _strategy_class <- Some _x248
  ...
  method grab_strategy_options = match _strategy_options with None->raise (Field_empty "ksDef.strategy_options") | Some _x249 -> _x249
  method set_strategy_options _x249 = _strategy_options <- Some _x249
  ...
  method grab_replication_factor = match _replication_factor with None->raise (Field_empty "ksDef.replication_factor") | Some _x250 -> _x250
  method set_replication_factor _x250 = _replication_factor <- Some _x250
  ...
  method grab_cf_defs = match _cf_defs with None->raise (Field_empty "ksDef.cf_defs") | Some _x251 -> _x251
  method set_cf_defs _x251 = _cf_defs <- Some _x251
  ...
  method set_durable_writes _x252 = _durable_writes <- _x252
  ...
  method write (oprot : Protocol.t) =
    ...
    (match _strategy_options with None -> () | Some _v -> 
      ...
      oprot#writeMapBegin(Protocol.T_STRING,Protocol.T_STRING,Hashtbl.length _v);
      Hashtbl.iter (fun _kiter255 -> fun _viter256 -> 
        oprot#writeString(_kiter255);
        oprot#writeString(_viter256);
      ) _v;
      oprot#writeMapEnd;
      oprot#writeFieldEnd
    );
    ...
    | Some _v -> 
      ...
      oprot#writeListBegin(Protocol.T_STRUCT,List.length _v);
      List.iter (fun _iter257 ->         _iter257#write(oprot);
      ) _v;
      oprot#writeListEnd;
      oprot#writeFieldEnd
    );
    ...
    (try while true do
        ...
        (match _id260 with 
          | 1 -> (if _t259 = Protocol.T_STRING then
              _str258#set_name iprot#readString
            else
              iprot#skip _t259)
          | 2 -> (if _t259 = Protocol.T_STRING then
              _str258#set_strategy_class iprot#readString
            else
              iprot#skip _t259)
          | 3 -> (if _t259 = Protocol.T_MAP then
              _str258#set_strategy_options 
                (let (_ktype262,_vtype263,_size261) = iprot#readMapBegin in
                let _con265 = Hashtbl.create _size261 in
                  for i = 1 to _size261 do
                    let _k = iprot#readString in
                    let _v = iprot#readString in
                      Hashtbl.add _con265 _k _v
                  done; iprot#readMapEnd; _con265)
            else
              iprot#skip _t259)
          | 4 -> (if _t259 = Protocol.T_I32 then
              _str258#set_replication_factor iprot#readI32
            else
              iprot#skip _t259)
          | 5 -> (if _t259 = Protocol.T_LIST then
              _str258#set_cf_defs 
                (let (_etype269,_size266) = iprot#readListBegin in
                  let _con270 = (Array.to_list (Array.init _size266 (fun _ -> (read_cfDef iprot)))) in
                    iprot#readListEnd; _con270)
            else
              iprot#skip _t259)
          | 6 -> (if _t259 = Protocol.T_BOOL then
              _str258#set_durable_writes iprot#readBool
            else
              iprot#skip _t259)
          | _ -> iprot#skip _t259);
        iprot#readFieldEnd;
...
object (self)
  val mutable _key : string option = None
  method get_key = _key
  method grab_key = match _key with None->raise (Field_empty "cqlRow.key") | Some _x272 -> _x272
  method set_key _x272 = _key <- Some _x272
  method unset_key = _key <- None
  method reset_key = _key <- None

  val mutable _columns : column list option = None
  method get_columns = _columns
  method grab_columns = match _columns with None->raise (Field_empty "cqlRow.columns") | Some _x273 -> _x273
  method set_columns _x273 = _columns <- Some _x273
  method unset_columns = _columns <- None
  method reset_columns = _columns <- None
    ...
    (try while true do
        ...
        (match _id279 with 
          | 1 -> (if _t278 = Protocol.T_STRING then
              ...
              iprot#skip _t278)
          | 2 -> (if _t278 = Protocol.T_LIST then
              _str277#set_columns 
                (let (_etype283,_size280) = iprot#readListBegin in
                  let _con284 = (Array.to_list (Array.init _size280 (fun _ -> (read_column iprot)))) in
...
object (self)
  ...
  method grab_type = match _type with None->raise (Field_empty "cqlResult.type") | Some _x286 -> _x286
  method set_type _x286 = _type <- Some _x286
  method unset_type = _type <- None
  method reset_type = _type <- None

  val mutable _rows : cqlRow list option = None
  method get_rows = _rows
  method grab_rows = match _rows with None->raise (Field_empty "cqlResult.rows") | Some _x287 -> _x287
  method set_rows _x287 = _rows <- Some _x287
  method unset_rows = _rows <- None
  method reset_rows = _rows <- None

  val mutable _num : int option = None
  method get_num = _num
  method grab_num = match _num with None->raise (Field_empty "cqlResult.num") | Some _x288 -> _x288
  method set_num _x288 = _num <- Some _x288
  ...
  method write (oprot : Protocol.t) =
    ...
    (match _rows with None -> () | Some _v -> 
      ...
      oprot#writeListBegin(Protocol.T_STRUCT,List.length _v);
      List.iter (fun _iter291 ->         _iter291#write(oprot);
      ) _v;
      oprot#writeListEnd;
      oprot#writeFieldEnd
    );
...
let rec read_cqlResult (iprot : Protocol.t) =
  let _str292 = new cqlResult in
    ...
    (try while true do
        ...
        (match _id294 with 
          | 1 -> (if _t293 = Protocol.T_I32 then
              _str292#set_type (CqlResultType.of_i iprot#readI32)
            else
              iprot#skip _t293)
          | 2 -> (if _t293 = Protocol.T_LIST then
              _str292#set_rows 
                (let (_etype298,_size295) = iprot#readListBegin in
                  let _con299 = (Array.to_list (Array.init _size295 (fun _ -> (read_cqlRow iprot)))) in
                    iprot#readListEnd; _con299)
            else
              iprot#skip _t293)
          | 3 -> (if _t293 = Protocol.T_I32 then
              _str292#set_num iprot#readI32
            else
              iprot#skip _t293)
          | _ -> iprot#skip _t293);
        iprot#readFieldEnd;
...
let rec read_notFoundException (iprot : Protocol.t) =
  let _str303 = new notFoundException in
    ignore(iprot#readStructBegin);
    (try while true do
        let (_,_t304,_id305) = iprot#readFieldBegin in
        if _t304 = Protocol.T_STOP then
          raise Break
        else ();
        (match _id305 with 
          | _ -> iprot#skip _t304);
...
object (self)
  ...
  method get_why = _why
  method grab_why = match _why with None->raise (Field_empty "invalidRequestException.why") | Some _x307 -> _x307
  method set_why _x307 = _why <- Some _x307
...
let rec read_invalidRequestException (iprot : Protocol.t) =
  let _str310 = new invalidRequestException in
    ignore(iprot#readStructBegin);
    (try while true do
        ...
        (match _id312 with 
          | 1 -> (if _t311 = Protocol.T_STRING then
              _str310#set_why iprot#readString
            else
              iprot#skip _t311)
          | _ -> iprot#skip _t311);
        iprot#readFieldEnd;
...
let rec read_unavailableException (iprot : Protocol.t) =
  let _str316 = new unavailableException in
    ignore(iprot#readStructBegin);
    (try while true do
...
let rec read_timedOutException (iprot : Protocol.t) =
  let _str322 = new timedOutException in
    ignore(iprot#readStructBegin);
    (try while true do
...
object (self)
  val mutable _why : string option = None
  method get_why = _why
  method grab_why = match _why with None->raise (Field_empty "authenticationException.why") | Some _x326 -> _x326
  method set_why _x326 = _why <- Some _x326
  method unset_why = _why <- None
  method reset_why = _why <- None
...
let rec read_authenticationException (iprot : Protocol.t) =
  let _str329 = new authenticationException in
    ignore(iprot#readStructBegin);
    (try while true do
        let (_,_t330,_id331) = iprot#readFieldBegin in
        if _t330 = Protocol.T_STOP then
          raise Break
        else ();
        (match _id331 with 
          | 1 -> (if _t330 = Protocol.T_STRING then
              _str329#set_why iprot#readString
            else
              iprot#skip _t330)
          | _ -> iprot#skip _t330);
        iprot#readFieldEnd;
...
object (self)
  val mutable _why : string option = None
  method get_why = _why
  method grab_why = match _why with None->raise (Field_empty "authorizationException.why") | Some _x333 -> _x333
  method set_why _x333 = _why <- Some _x333
  method unset_why = _why <- None
  method reset_why = _why <- None
...
let rec read_authorizationException (iprot : Protocol.t) =
  let _str336 = new authorizationException in
    ignore(iprot#readStructBegin);
    (try while true do
        ...
        (match _id338 with 
          | 1 -> (if _t337 = Protocol.T_STRING then
              _str336#set_why iprot#readString
            else
              iprot#skip _t337)
          | _ -> iprot#skip _t337);
        iprot#readFieldEnd;
...
let rec read_schemaDisagreementException (iprot : Protocol.t) =
  let _str342 = new schemaDisagreementException in
    ignore(iprot#readStructBegin);
    (try while true do
